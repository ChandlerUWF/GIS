...
main: test/main.cpp test/point.o test/polygon.o test/matrix3d.o test/gis.o
	$(CXX) $(CXXFLAGS) -o main $^

test-1-point: test/catch/catch.o test/test-1-point.cpp test/point.o
	$(CXX) $(CXXFLAGS) -o test/test-1-point $^
	test/test-1-point --success

test-2-polygon: test/catch/catch.o test/test-2-polygon.cpp test/point.o test/polygon.o test/matrix3d.o
	$(CXX) $(CXXFLAGS) -o test/test-2-polygon $^
	test/test-2-polygon --success

test-3-matrix3d: test/catch/catch.o test/test-3-matrix3d.cpp test/point.o test/polygon.o test/matrix3d.o # TODO other required files
	$(CXX) $(CXXFLAGS) -o test/test-3-matrix3d $^
	test/test-3-matrix3d --success

test-4-polygon-advanced: test/catch/catch.o test/test-4-polygon-advanced.cpp test/point.o test/polygon.o test/matrix3d.o # TODO other required files
	$(CXX) $(CXXFLAGS) -o test/test-4-polygon-advanced $^
	test/test-4-polygon-advanced --success

test-5-gis: test/catch/catch.o test/test-5-gis.cpp test/point.o test/polygon.o test/matrix3d.o test/gis.o # TODO other required files
